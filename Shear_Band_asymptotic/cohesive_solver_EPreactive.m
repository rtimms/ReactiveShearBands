function [T_centreline_max,t_end] = cohesive_solver_EPreactive(rho_hat,S,lambda,omega,gammadot0,eps,beta1,beta2,T_p,s_p,t_p,q_flux,N,y,dy,dt,FILENAME,t_stop,Omega_hat,A0_hat,E_hat,T_R)
...
% Save to file
filename = sprintf('numerical_%s_N%.0f',FILENAME,N);
...
while time < t_stop
    ...
    % Iterate between thermal and mechanical
    while tol > 1e-6
        ...
        [velNew,stressNew,gdotNew,gNew,converge_m] = ...
            mechanical_solver_exp(velOld,stressOld,gdotOld,gOld,TPred,rho_hat,S,omega,gammadot0,eps,beta1,beta2,T_p,s_p,y,dy,dt,N);
        ...
        % Update temperature
        TNew = thermal_solver_reactive(stressOld,gdotOld,TOld,stressNew,gdotNew,TPred,lambda,dy,dt,N,time,q_flux,Omega_hat,A0_hat,E_hat,T_R);
